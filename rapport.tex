...
%% 40 -> 50
  ...
  le nouveau Coqdoc.
    ...
    contenues dans le code source afin d'en constituer un guide de réference
    ou un manuel, sous forme de pages webs ou de documents PDF.
    ...
    \begin{itemize}
      ...
      \item \textbf{Variété des formats de sortie :} \\
        ...
        documentation, allant de la génération de pages webs à la génération de
        PDF.
    \end{itemize}
    ...
    \begin{figure}
      \lstinputlisting
        {source1.v}
      \fbox{
      \includegraphics[trim=0mm 0mm 2cm 0cm,clip=true, width=\textwidth]{rendu1.png}}
    ...
    présentes dans le code source, permettent de formater le fichier de sortie.
    \begin{itemize}
      ...
      "(**" est une portion de texte devant apparaitre dans la documentation
      générée.
      \item[] \textbf{Titres :} \\
      ...
      \item[] \textbf{Listes :} \\
        ...
        est un élément d'une liste, dont le niveau de profondeur est détérminé
      ...
      \item[] \textbf{Règles de traduction :} \\
        ...
        \end{itemize}
    \end{itemize}
    La figure \ref{source2} donne un exemple de ces règles de formattages
    dans le fichier d'entrée
    \begin{figure}
      \lstinputlisting{source2.v}
      \caption{Exemple des règles de formattage de Coqdoc}
      \label{source2}
    \end{figure}
