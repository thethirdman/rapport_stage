...
%% 40 -> 50
  ...
  au cours du stage.
    ...
    %% Protocole d'interaction existant
    ...
    \subsection{Protocole d'interaction avec l'interprète} %% FIXME: reformuler
    %% Analyse des besoins
    ...
    %% Detailler les types
    %% Envoi du code a coqtop
    %% Traitement des commentaires
    %% Traitement de la documentation
    %% Type final, bien mettre en avant que il ne reste plus rien à evaluer
    %% grâces au types
