...
%% 40 -> 50
  ...
  le déroulement du stage.
    ...
    %% Joli graphique, expliquer précisément les différentes parties du
    \begin{figure}
      \fbox{\includegraphics[scale=0.4]{data/devchain.png}}
    ...
    \subsection{Protocole d'interaction avec l'interprète} %% FIXME: fusion ???
    \subsection{Phase d'évaluation du document}
    \subsection{Génération des documents finaux}
    %% Détailler le développement de chaque phase
